...
class Board:
	def __init__(self):
		...
		self.mine = pygame.image.load(os.path.join(dir_path, "images\\mine.jpg"))
		self.mine = pygame.transform.scale(self.mine, (30,30))
		self.losingmine = pygame.image.load(os.path.join(dir_path, "images\\losingmine.jpg"))
		self.losingmine = pygame.transform.scale(self.losingmine, (30,30))
		self.flag = pygame.image.load(os.path.join(dir_path, "images\\flag.png"))
		self.flag = pygame.transform.scale(self.flag, (30,30))
		self.unknown = pygame.image.load(os.path.join(dir_path, "images\\unknown.png"))
		self.unknown = pygame.transform.scale(self.unknown, (30,30))
		self.zero = pygame.image.load(os.path.join(dir_path, "images\\0.png"))
		self.zero = pygame.transform.scale(self.zero, (30,30))
		self.one = pygame.image.load(os.path.join(dir_path, "images\\1.png"))
		self.one = pygame.transform.scale(self.one, (30,30))
		self.two = pygame.image.load(os.path.join(dir_path, "images\\2.png"))
		self.two = pygame.transform.scale(self.two, (30,30))
		self.three = pygame.image.load(os.path.join(dir_path, "images\\3.png"))
		self.three = pygame.transform.scale(self.three, (30,30))
		self.four = pygame.image.load(os.path.join(dir_path, "images\\4.png"))
		self.four = pygame.transform.scale(self.four, (30,30))
		self.five = pygame.image.load(os.path.join(dir_path, "images\\5.png"))
		self.five = pygame.transform.scale(self.five, (30,30))
		self.six = pygame.image.load(os.path.join(dir_path, "images\\6.png"))
		self.six = pygame.transform.scale(self.six, (30,30))
		self.seven = pygame.image.load(os.path.join(dir_path, "images\\7.png"))
		self.seven = pygame.transform.scale(self.seven, (30,30))
		self.eight = pygame.image.load(os.path.join(dir_path, "images\\8.png"))
